...
public class TransportHelper {
    ...
    public TransportHelper() {
        ...
        route9_transports.add(new Transport("ba 1 pa 4020", "bus", 9, new LatLng(27.67980376, 85.39870264),0)); // Nikoshera
        route9_transports.add(new Transport("ba 1 pa 4017", "bus", 9, new LatLng(27.68254001, 85.3723526),0));// Sanothimi
        route9_transports.add(new Transport("ba 1 pa 4014", "bus", 9, new LatLng(27.67668738, 85.35291195),0)); // Jadibuti

        route9_transports.add(new Transport("ba 1 pa 4019", "bus", 9, new LatLng(27.67986969, 85.34947753),1)); // koteshwor bus stand
        route9_transports.add(new Transport("ba 1 pa 4020", "bus", 9, new LatLng(27.68819282, 85.3360033),1)); // New Baneshwor chwok
        route9_transports.add(new Transport("ba 1 pa 4021", "bus", 9, new LatLng(27.69363633, 85.32029629),1)); // Maitighar
        ...
        route10_transports.add(new Transport("ba 1 pa 3017", "micro-bus", 10, new LatLng(27.67511016, 85.35338402),0)); //Jadibuti bus stand
        route10_transports.add(new Transport("ba 1 pa 3018", "micro-bus", 10, new LatLng(27.68001278, 85.34947872),0)); //Koteshwor
        route10_transports.add(new Transport("ba 1 pa 3019", "micro-bus", 10, new LatLng(27.68603623, 85.3454876),0)); // Koteshwor Tinkune

        route10_transports.add(new Transport("ba 1 pa 3010", "micro-bus", 10, new LatLng(27.68814532, 85.33623934),1)); // New Baneshwor chowk stand
        route10_transports.add(new Transport("ba 1 pa 3011", "micro-bus", 10, new LatLng(27.69321834, 85.32220602),1)); // Babarmahal
        route10_transports.add(new Transport("ba 1 pa 3020", "micro-bus", 10, new LatLng(27.69976353, 85.31510353),1)); // Shahid gate
